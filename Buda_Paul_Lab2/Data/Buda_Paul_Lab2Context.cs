...
namespace Buda_Paul_Lab2.Data
{
    public class Buda_Paul_Lab2Context : DbContext
    {
        ...
        public DbSet<Buda_Paul_Lab2.Models.Author> Author { get; set; } = default!;
        public DbSet<Buda_Paul_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Buda_Paul_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Buda_Paul_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
